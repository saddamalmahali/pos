...
<form action="{{url('/transaksi/penjualan/simpan_transaksi_penjualan')}}" class="form-penjualan" method="POST">
    {{csrf_field()}}
                    ...
                    <div class="col-md-8">
                        <div class="form-inline" style="margin-top:10px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="bayar" name="bayar" required class="form-control bayar">
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">Info Penjualan</h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-md-4">
                            <table>
                                <tr>
                                    <th width="40%" style="vertical-align:middle;">No. Nota</th>
                                    <td width="10%" style="vertical-align:middle;">:</td>
                                    <td><input type="text" style="margin-bottom:10px;" readonly class="form-control" value="{{$penjualan->nota}}"></td>
                                </tr>
                                <tr>
                                    <th width="40%">Tanggal</th>
                                    <td width="10%">:</td>
                                    <td><input type="text" readonly class="form-control" value="{{$penjualan->tanggal_jual}}"></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
                            <table>
                                <tr>
                                    <th width="40%" style="vertical-align:middle;">Pembeli</th>
                                    <td width="10%" style="vertical-align:middle;">:</td>
                                    <?php
                                        $mp = '';
                                        if($penjualan->transaksi_member != null){
                                            $mp = $penjualan->transaksi_member->member->nama;
                                        }else{
                                            if($penjualan->pelanggan != null){
                                                $mp = $penjualan->pelanggan->no_plat;
                                            }else{
                                                $mp = "Bukan Pelanggan/Member";
                                            }
                                        }
                                    ?>
                                    <td><input type="text" style="margin-bottom:10px;" readonly class="form-control" value="{{$mp}}"></td>
                                </tr>
                                <tr>
                                    ...
                                    <?php 
                                        ...
                                        if($penjualan->tipe_user == 1){
                                            $kasir = Karyawan::find($penjualan->id_user)->nama_lengkap;
                                        }else{
                                            $kasir = User::find($penjualan->id_user)->name;
                                        }
                                    ?>
                                    <td><input type="text" readonly class="form-control" value="{{$kasir}}"></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
                            <table>
                                <tr>
                                    <th width="40%" style="vertical-align:middle;">Teknisi</th>
                                    <td width="10%" style="vertical-align:middle;">:</td>
                                    <td><input type="text" style="margin-bottom:10px;" readonly class="form-control" value="{{$penjualan->id_teknisi == null ? "" : Karyawan::find($penjualan->id_teknisi)->nama_lengkap}}"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <table class="table" >
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%" style="text-align:center;">disc (%)</th>
