<header class="header-top navbar fixed-top">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{url('/home')}}">
            ...
            <span class="text-center">&nbsp;&nbsp;&nbsp;<b>{{\App\CompanyProfile::find(1)->nama_toko}}</b></span>
        </a>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="user-profile dropdown">
                <a href="javascript:;" class="clearfix dropdown-toggle" data-toggle="dropdown">
                    <img src="{{url('img/blank-user-medium.png')}}" alt="" class="hidden-sm">
                    <div class="user-name">{{auth('web')->user()->name}} <small class="fa fa-angle-down"></small></div>
                </a>
