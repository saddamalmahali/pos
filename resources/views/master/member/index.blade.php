...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-right">
                                    <a href="{{url('/master/admin/member/tambah')}}" style="margin-bottom:10px;" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp; Tambah Data</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                @forelse ($data_member as $member)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="{{url('/master/admin/member/edit').'/'.$member->id}}" class="btn btn-rounded btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                                            <a href="" class="btn btn-rounded btn-danger btn-xs btn-hapus" id="{{$member->id}}"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                @empty
    ...
    <script>
        ...
        var url_back = "{{url('/master/admin/member')}}";
        $(function(){
            $.ajaxSetup({
                headers: {
