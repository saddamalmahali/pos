            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4 class="panel-title">Update Supplier</h4>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('kode') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="kode" class="form-control" readonly style="width:50%;" value="{{ $supplier->kode }}" placeholder="Kode Supplier" >
                                    @if ($errors->has('kode'))
                                ...
                                <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="nama" class="form-control" value="{{ $supplier->nama_supplier }}" placeholder="Nama Supplier">
                                    @if ($errors->has('nama'))
                                        <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('no_telp') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="no_telp" class="form-control" value="{{ $supplier->no_telp }}" placeholder="No Telp Supplier">
