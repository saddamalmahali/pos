        ...
        <table width="100%">
            <tr>
                ...
                <td align="left">
                    ...
                    {{date('d-m-Y', strtotime($penjualan->tanggal_jual))}} || {{date('H:m:s a', strtotime($penjualan->created_at))}}
                    ...
                    @else
                        <table>
                            <tr>
                                <td style="vertical-align: middle; padding: 0px; width :12%;">Pelanggan </td>
                                <td style="vertical-align: middle; padding: 0px;"> : </td>
                                <td style="vertical-align: middle; padding: 0px;">{{$penjualan->pelanggan == '' ? '-' : $penjualan->pelanggan->no_plat}}</td>
                            </tr>
                            <tr>
                                <td style="vertical-align: middle; padding: 0px; width :12%;">No Telp </td>
                                <td style="vertical-align: middle; padding: 0px;"> : </td>
                                <td style="vertical-align: middle; padding: 0px;">{{$penjualan->pelanggan == '' ? '-' : $penjualan->pelanggan->no_telp}}</td>
                            </tr>
                        </table>
